...
from lector import parse_qap
from fobjetive import QAPObjectiveFunction
...
def test_qap(n = 5, i = 0):
    ...
    #print('instancias:',instancias),os.system('pause')
    #print('flux_mats:', flux_mats), os.system('pause')
    #print('dist_mat:', dist_mat), os.system('pause')
    ...
    #pareto_front.draw()
    #print(pareto_set.solutions[2].solution),os.system('pause')
    #print(len(pareto_set.solutions[2].solution))
    return pareto_set
